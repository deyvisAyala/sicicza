...
@if($message=='create')
        ...
        @endif
          ...
          <h3 class="page-header"><i class="fa fa-truck "></i> Detalles factura</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.html">Inicio</a></li>
            <li><i class="fa fa-truck"></i>ver</li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
           <table class="table table-bordered data-table"  style="background-color: #c8daea">
              <thead style="background-color: SteelBlue ">
                <tr>
                  ...
                  <th style="color: black">Total</th>
                   <th style="color: black"># de cuotas</th>
             ...
             <td>fhfhf</td>
                 <td> <a  href="/sicicza/public/DetalleFactura"  class="btn btn-info" data-id="1"  data-target="#Edit1">Detalle</a></td>
